...
HeartBeam::HeartBeam() : DRAW_RANGE_TIME_(1000){
	...
	this->pos_ = Vector3( (1280.0f - 426.0f) / 2.0f,(720.0f - 426.0f) / 2.0f,0.0f);
	...
	for (auto time : this->heartsTimes_){
		{
			...
			SpriteBatch.Draw(*(this->sp_),this->pos_,1.0f,Vector3_Zero,
				Vector3(426.0f / 2.0f, 426.0f / 2.0f,0.0f),scale);
